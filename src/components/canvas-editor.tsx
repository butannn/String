          ...
          >
            <svg className="absolute inset-0 h-full w-full">
              ...
              {attachments.map((attachment) => {
                ...
                return (
                  <g key={attachment.id} filter="url(#stringShadow)">
                    <path
                      d={path}
                      fill="none"
                      stroke="transparent"
                    ...
                    <path
                      d={path}
                      fill="none"
                      stroke={isAttachmentSelected ? "#111111" : "#3a3a3a"}
                      strokeWidth={8}
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      vectorEffect="non-scaling-stroke"
                    ...
                    <path
                      ...
                      className="pointer-events-none"
                    />
                    {/* Primary twisted-strand highlight */}
                    <path
                      d={path}
                      fill="none"
                      stroke={isAttachmentSelected ? "#ffe08a" : "#d4c5a9"}
                      strokeWidth={2.8}
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      ...
                      className="pointer-events-none"
                    />
                    {/* Secondary highlight offset — simulates opposite strand */}
                    <path
                      d={path}
                      fill="none"
                      stroke="#c8b89a"
                      ...
                      className="pointer-events-none"
                    />
                    {/* Fine shadow groove between strands */}
                    <path
                      d={path}
                      fill="none"
                      stroke="#1a1410"
